...
--
-- Hôte : localhost
-- Généré le : sam. 27 sep. 2025 à 03:43
...
--
-- Déchargement des données de la table `admin_chat_status`
--
...
(1, 'Admin Système', '+225 07 00 00 00 00', 'admin@suzosky.com', 'admin', 'support_client', 'actif', 0, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, '2025-08-08 09:03:00'),
...
CREATE TABLE `agents_suzosky` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `password` varchar(255) DEFAULT NULL COMMENT 'Mot de passe hashé',
  `password_plain` varchar(50) DEFAULT NULL COMMENT 'Mot de passe en clair (temporaire)',
  `first_login_done` tinyint(1) DEFAULT 0 COMMENT 'Premier login effectué',
  `password_changed_at` timestamp NULL DEFAULT NULL COMMENT 'Date dernier changement mot de passe',
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Date mise à jour',
...
--
-- Déchargement des données de la table `agents_suzosky`
--
...
(3, 'CM20250001', 'YAPO', 'Emmanuel', '1990-01-01', 'abidjan', 'coursier_moto', '0758842029', 'yapadone@gmail.com', 'cni', 'AUTO_20250827094600', 'À renseigner', '0000000000', 'À renseigner', 'actif', NULL, '2025-08-27 07:46:00', NULL, NULL, 0, NULL, '2025-08-27 07:46:00', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'CM20250002', 'DEMBA', 'IBRAHIM', '1988-12-31', 'BAFOULABE / MALI', 'coursier_moto', '0777036262', 'demba.ibrahim@suzosky.com', 'cni', '18801204016013M', 'À renseigner', '0000000000', 'À renseigner', 'actif', NULL, '2025-08-27 09:00:31', '$2y$10$z.BTOQi4IX9ly/.sdoASY..DO/hLqxYBOyO2it5CFPx8YNxejp5Ke', NULL, 0, NULL, '2025-09-15 19:53:42', 'RsJyY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
--
-- Déchargement des données de la table `app_crashes`
--
...
CREATE TABLE `app_devices` (
  `id` int(11) UNSIGNED NOT NULL,
  `device_id` varchar(128) NOT NULL COMMENT 'Android ID ou UUID généré',
  `courier_id` int(11) UNSIGNED DEFAULT NULL COMMENT 'ID du coursier si connecté',
  `device_model` varchar(100) DEFAULT NULL COMMENT 'Modèle appareil',
...
--
-- Déchargement des données de la table `app_devices`
--
...
--
-- Déchargement des données de la table `app_sessions`
--
...
CREATE TABLE `app_versions` (
  `id` int(11) UNSIGNED NOT NULL,
  `version_code` int(11) NOT NULL COMMENT 'Code version numérique',
...
--
-- Déchargement des données de la table `app_versions`
--
...
(1, 1, '1.0', 'suzosky-coursier-production.apk', 18639158, 24, 'Version initiale avec télémétrie', 0, 0, '2025-09-18 21:59:54', '2025-09-18 21:59:54'),
(2, 2, '1.1', 'suzosky-coursier-20250918-220821.apk', 18639158, 24, 'Upload automatique du 18/09/2025 à 22:08', 0, 0, '2025-09-18 22:08:21', '2025-09-18 22:08:21'),
(3, 3, '1.2', 'suzosky-coursier-20250918-230925.apk', 18639158, 24, 'Upload automatique du 18/09/2025 à 23:09', 0, 0, '2025-09-18 23:09:25', '2025-09-18 23:09:25'),
(4, 4, '1.3', 'suzosky-coursier-20250918-231936.apk', 18639158, 24, 'Upload automatique du 18/09/2025 à 23:19', 0, 0, '2025-09-18 23:19:36', '2025-09-18 23:19:36'),
(5, 5, '1.4', 'suzosky-coursier-20250918-232702.apk', 18639158, 24, 'Upload automatique du 18/09/2025 à 23:27', 0, 0, '2025-09-18 23:27:02', '2025-09-18 23:27:02'),
(6, 6, '1.5', 'suzosky-coursier-20250919-085702.apk', 18639190, 24, 'Upload automatique du 19/09/2025 à 08:57', 0, 0, '2025-09-19 08:57:02', '2025-09-19 08:57:02'),
(7, 7, '1.6', 'suzosky-coursier-20250919-101127.apk', 18639282, 24, 'Upload automatique du 19/09/2025 à 10:11', 0, 0, '2025-09-19 10:11:27', '2025-09-19 10:11:27'),
(8, 8, '1.7', 'suzosky-coursier-20250919-101743.apk', 25840207, 24, 'Upload automatique du 19/09/2025 à 10:17', 0, 0, '2025-09-19 10:17:43', '2025-09-19 10:17:43'),
(9, 9, '1.8', 'suzosky-coursier-20250919-113906.apk', 18774940, 24, 'Upload automatique du 19/09/2025 à 11:39', 0, 0, '2025-09-19 11:39:06', '2025-09-19 11:39:06'),
(10, 10, '1.9', 'suzosky-coursier-20250919-120138.apk', 18775216, 24, 'Upload automatique du 19/09/2025 à 12:01', 0, 0, '2025-09-19 12:01:38', '2025-09-19 12:01:38'),
(11, 11, '1.10', 'suzosky-coursier-20250919-124539.apk', 18776236, 24, 'Upload automatique du 19/09/2025 à 12:45', 0, 0, '2025-09-19 12:45:39', '2025-09-19 12:45:39'),
(12, 12, '1.11', 'suzosky-coursier-20250919-190451.apk', 18776154, 24, 'Upload automatique du 19/09/2025 à 19:04', 0, 0, '2025-09-19 19:04:51', '2025-09-19 19:04:51'),
(13, 13, '1.12', 'suzosky-coursier-20250919-190621.apk', 18776154, 24, 'Upload automatique du 19/09/2025 à 19:06', 0, 0, '2025-09-19 19:06:21', '2025-09-19 19:06:21'),
(14, 14, '1.13', 'suzosky-coursier-20250919-191553.apk', 18776154, 24, 'Upload automatique du 19/09/2025 à 19:15', 0, 0, '2025-09-19 19:15:53', '2025-09-19 19:15:53'),
(16, 15, '1.14', 'suzosky-coursier-20250921-084416.apk', 19466689, 24, 'Upload automatique du 21/09/2025 à 08:44', 0, 1, '2025-09-21 08:44:17', '2025-09-21 08:44:17');
...
--
-- Déchargement des données de la table `candidatures_suzosky`
--
...
(1, 'KOUASSI', 'Jean Baptiste', '+225 07 12 34 56 78', 'kouassi.jean@email.com', 'coursier_moto', 'Expérience de 3 ans en livraison', NULL, 'en_attente', '2025-08-10 06:08:34', NULL),
(2, 'TRAORE', 'Aminata', '+225 05 98 76 54 32', 'traore.aminata@email.com', 'agent_conciergerie', 'Formation en service clientèle', NULL, 'en_attente', '2025-08-10 06:08:34', NULL),
(3, 'DIABATE', 'Seydou', '+225 01 11 22 33 44', 'diabate.seydou@email.com', 'chauffeur', '5 ans d\'expérience en transport', NULL, 'en_attente', '2025-08-10 06:08:34', NULL);
...
(1, 'particulier', 99999, 'Test de création', '2025-09-19 07:45:28', 1, '2025-09-19 07:45:28'),
(2, 'particulier', 99999, 'Test de création', '2025-09-19 07:45:37', 1, '2025-09-19 07:45:37'),
(3, 'particulier', 99999, 'Test de création', '2025-09-19 07:46:44', 1, '2025-09-19 07:46:44'),
...
(19, 'particulier', 99999, 'Test de création', '2025-09-22 17:28:02', 1, '2025-09-22 17:28:02'),
...
--
-- Déchargement des données de la table `chat_messages_suzosky`
--
...
--
-- Déchargement des données de la table `chat_quick_replies`
--
...
(2, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:40'),
(3, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:40'),
(4, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:40'),
(5, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:40'),
(6, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:40'),
...
(8, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:44'),
(9, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
(10, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:44'),
(11, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
(12, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
...
(14, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:44'),
(15, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
(16, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:44'),
(17, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
(18, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
...
(20, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:44'),
(21, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
(22, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:44'),
(23, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
(24, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:44'),
...
(26, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:47'),
(27, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:47'),
(28, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:47'),
(29, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:47'),
(30, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:47'),
...
(32, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:47'),
(33, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:47'),
(34, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:47'),
(35, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:47'),
(36, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:47'),
...
(38, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:50'),
(39, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:50'),
(40, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:50'),
(41, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:50'),
(42, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:50'),
...
(44, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:50'),
(45, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:50'),
(46, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:50'),
(47, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:50'),
(48, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:50'),
...
(50, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:53'),
(51, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
(52, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:53'),
(53, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
(54, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
...
(56, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:53'),
(57, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
(58, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:53'),
(59, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
(60, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
...
(62, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:53'),
(63, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
(64, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:53'),
(65, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
(66, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:53'),
...
(68, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:55'),
(69, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:55'),
(70, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:55'),
(71, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:55'),
(72, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:55'),
...
(74, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:56'),
(75, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:56'),
(76, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:56'),
(77, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:56'),
(78, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:56'),
...
(80, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:56'),
(81, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:56'),
(82, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:56'),
(83, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:56'),
(84, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:56'),
...
(86, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:59'),
(87, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:59'),
(88, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:59'),
(89, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:59'),
(90, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:59'),
...
(92, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:18:59'),
(93, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:18:59'),
(94, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:18:59'),
(95, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:18:59'),
(96, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:18:59'),
...
(98, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:19:05'),
(99, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:19:05'),
(100, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:19:05'),
(101, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:19:05'),
(102, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:19:05'),
...
(104, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:19:07'),
(105, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:19:07'),
(106, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:19:07'),
(107, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:19:07'),
(108, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:19:07'),
...
(110, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 04:21:48'),
(111, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 04:21:48'),
(112, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 04:21:48'),
(113, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 04:21:48'),
(114, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 04:21:48'),
...
(116, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:11:57'),
(117, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:11:57'),
(118, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:11:57'),
(119, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:11:57'),
(120, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:11:57'),
...
(122, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:34:29'),
(123, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:34:29'),
(124, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:34:29'),
(125, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:34:29'),
(126, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:34:29'),
...
(128, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:34:36'),
(129, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:34:36'),
(130, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:34:36'),
(131, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:34:36'),
(132, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:34:36'),
...
(134, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:34:44'),
(135, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:34:44'),
(136, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:34:44'),
(137, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:34:44'),
(138, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:34:44'),
...
(140, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:34:47'),
(141, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:34:47'),
(142, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:34:47'),
(143, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:34:47'),
(144, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:34:47'),
...
(146, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:34:47'),
(147, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:34:47'),
(148, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:34:47'),
(149, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:34:47'),
(150, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:34:47'),
...
(152, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:34:51'),
(153, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:34:51'),
(154, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:34:51'),
(155, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:34:51'),
(156, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:34:51'),
...
(158, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:34:53'),
(159, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:34:53'),
(160, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:34:53'),
(161, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:34:53'),
(162, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:34:53'),
...
(164, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:34:53'),
(165, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:34:53'),
(166, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:34:53'),
(167, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:34:53'),
(168, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:34:53'),
...
(170, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:35:05'),
(171, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:35:05'),
(172, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:35:05'),
(173, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:35:05'),
(174, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:35:05'),
...
(176, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:35:06'),
(177, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:35:06'),
(178, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:35:06'),
(179, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:35:06'),
(180, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:35:06'),
...
(182, 'Merci et fermeture', 'Merci pour votre confiance en SUZOSKY ! N\'hésitez pas à nous recontacter si vous avez d\'autres questions.', 'closing', 1, 0, 1, '2025-08-11 05:35:06'),
(183, 'Informations générales', 'Pour plus d\'informations sur nos services, je vous invite à consulter notre site web ou à nous appeler directement.', 'info', 1, 0, 1, '2025-08-11 05:35:06'),
(184, 'Prise de contact', 'Je prends note de votre demande. Un de nos conseillers va vous recontacter dans les plus brefs délais.', 'escalation', 1, 0, 1, '2025-08-11 05:35:06'),
(185, 'Délai de livraison', 'Nos délais de livraison standard sont de 30 minutes à 2h selon la zone géographique et le type de service demandé.', 'info', 1, 0, 1, '2025-08-11 05:35:06'),
(186, 'Tarification', 'Nos tarifs varient selon la distance et le type de service. Souhaitez-vous que je vous fasse un devis personnalisé ?', 'info', 1, 0, 1, '2025-08-11 05:35:06');
...
(13, 'YAPO', 'Expéditeur', '+2250758842029', 'yapadone@gmail.com', '2025-09-01 03:33:07', '2025-09-03 00:08:13', '0000-00-00 00:00:00', 0.00, 'client'),
...
--
-- Déchargement des données de la table `clients_business`
--
...
(2, 'Express Logistics', 'Marie Traoré', '+225 07 22 22 22 22', 'contact@express-logistics.ci', NULL, 'standard', 0.00, 0.00, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'actif', '2025-08-08 09:03:00', NULL, '2025-08-08 09:03:00', '2025-08-08 09:03:00');
...
--
-- Déchargement des données de la table `clients_particuliers`
--
...
CREATE TABLE `clients_unified` (
  ...
  `statut` enum('actif','inactif','suspendu') DEFAULT 'actif',
  `concierge_id` int(11) DEFAULT NULL COMMENT 'ID du concierge assigné',
  `date_inscription` timestamp NULL DEFAULT current_timestamp(),
  `derniere_commande` timestamp NULL DEFAULT NULL,
  `total_commandes` int(11) DEFAULT 0,
  `ca_total` decimal(12,2) DEFAULT 0.00,
...
(2, 'SZK20250903076d35', '', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-03 00:47:05', '2025-09-03 00:47:05', 1, 2, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(4, '', 'SZK202509033b993b', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-03 00:57:03', '2025-09-03 00:57:03', 1, 2, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(32, 'SZK20250904c95509', 'SZK250904347444', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 10:38:18', '2025-09-04 10:38:18', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(33, 'SZK202509049945e8', 'SZK250904226797', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 10:43:17', '2025-09-04 10:43:17', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(34, 'SZK202509045a337a', 'SZK250904843966', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 10:47:19', '2025-09-04 10:47:19', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(35, 'SZK20250904e9d68e', 'SZK250904397534', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 12:30:50', '2025-09-04 12:30:50', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(36, 'SZK202509047a8f68', 'SZK250904389863', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 12:32:22', '2025-09-04 12:32:22', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(37, 'SZK20250904d4f58e', 'SZK250904506131', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 12:54:18', '2025-09-04 12:54:18', 13, 13, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250758842029'),
(38, 'SZK20250904d2b896', 'SZK250904113431', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 14:06:16', '2025-09-04 14:06:16', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(39, 'SZK202509049d6e98', 'SZK250904128129', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 14:42:44', '2025-09-04 14:42:44', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(40, 'SZK20250904dfec60', 'SZK250904912573', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 15:22:46', '2025-09-04 15:22:46', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(41, 'SZK202509047656d0', 'SZK250904566350', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 15:24:45', '2025-09-04 15:24:45', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(42, 'SZK202509044087a6', 'SZK250904340303', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 15:34:18', '2025-09-04 15:34:18', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(43, 'SZK20250904d8fc73', 'SZK250904989811', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 16:10:35', '2025-09-04 16:10:35', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(44, 'SZK2025090486bff8', 'SZK250904280870', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 16:18:46', '2025-09-04 16:18:46', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(45, 'SZK2025090487d6f5', 'SZK250904394884', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 16:27:45', '2025-09-04 16:27:45', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(46, 'SZK202509047c2e1d', 'SZK250904417150', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 17:57:16', '2025-09-04 17:57:16', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(47, 'SZK20250904b50001', 'SZK250904420793', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:03:20', '2025-09-04 18:03:20', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(48, 'SZK202509043f5c95', 'SZK250904100350', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:05:35', '2025-09-04 18:05:35', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(49, 'SZK20250904efaabf', 'SZK250904789369', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:23:12', '2025-09-04 18:23:12', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(50, 'SZK202509043b0367', 'SZK250904401561', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:24:07', '2025-09-04 18:24:07', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(51, 'SZK20250904c340b9', 'SZK250904770527', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:26:57', '2025-09-04 18:26:57', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(53, 'SZK202509040e1697', 'SZK250904504953', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:30:29', '2025-09-04 18:30:29', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(54, 'SZK20250904dbb7c3', 'SZK250904811969', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:32:42', '2025-09-04 18:32:42', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(55, 'SZK202509045992d7', 'SZK250904546863', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:33:42', '2025-09-04 18:33:42', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(56, 'SZK20250904d43fde', 'SZK250904424431', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:37:15', '2025-09-04 18:37:15', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(57, 'SZK20250904c7da25', 'SZK250904179379', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:37:33', '2025-09-04 18:37:33', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(58, 'SZK20250904926449', 'SZK250904597415', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:38:06', '2025-09-04 18:38:06', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(59, 'SZK2025090432ab7d', 'SZK250904510492', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 18:52:48', '2025-09-04 18:52:48', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(60, 'SZK202509043f948f', 'SZK250904670906', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 19:03:41', '2025-09-04 19:03:41', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(61, 'SZK202509041156a3', 'SZK250904463128', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 19:14:38', '2025-09-04 19:14:38', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(62, 'SZK202509043e090f', 'SZK250904175678', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 19:16:24', '2025-09-04 19:16:24', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(63, 'SZK202509047886be', 'SZK250904352019', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 19:20:56', '2025-09-04 19:20:56', 155, 156, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2252250758842', '+2252250575584'),
(64, 'SZK20250904555505', 'SZK250904609929', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 19:22:13', '2025-09-04 19:22:13', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(65, 'SZK20250904a37b85', 'SZK250904351725', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 19:32:38', '2025-09-04 19:32:38', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(66, 'SZK2025090476116a', 'SZK250904458738', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6400.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 19:41:24', '2025-09-04 19:41:24', 161, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758853029', '+2250102453769'),
(67, 'SZK20250904570f95', 'SZK250904775624', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 8320.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 20:03:46', '2025-09-04 20:03:46', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(68, 'SZK2025090480483d', 'SZK250904233178', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 8320.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 20:07:19', '2025-09-04 20:07:19', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(69, 'SZK20250904ac79e4', 'SZK250904257979', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 8320.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 20:13:44', '2025-09-04 20:13:44', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(70, 'SZK202509041d0a5c', 'SZK250904310764', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 8320.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 20:16:27', '2025-09-04 20:16:27', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(71, 'SZK2025090429b498', 'SZK250904869870', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'livree', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 8320.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-04 20:18:25', '2025-09-26 14:18:16', 13, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+2250758842029', '+2250102453769'),
(72, 'SZK20250921594571', 'SZK250921225224', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'livree', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-21 08:24:00', '2025-09-26 14:17:47', 3, 1, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '+225 01 02 45 37 69', '+225 07 58 84 20 29'),
...
(78, 'SZK2025092132be3c', 'SZK250921861842', 'particulier', 15, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'livree', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-21 17:31:37', '2025-09-26 14:16:48', 15, 16, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250758842029', '2250102453769'),
(79, 'SZK20250926e44b9b', 'SZK250926898369', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 15:05:57', '2025-09-26 15:05:57', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(80, 'SZK20250926f401d9', 'SZK250926839870', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 15:13:21', '2025-09-26 15:13:21', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(81, 'SZK20250926878ed8', 'SZK250926501773', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 15:13:32', '2025-09-26 15:13:32', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(82, 'SZK20250926d7acf5', 'SZK250926132244', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 6713.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 15:31:13', '2025-09-26 15:31:13', 16, 15, 'Chawarma+ 8e Tranche, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(83, 'SZK202509264f8bc4', 'SZK250926321812', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 15:54:21', '2025-09-26 15:54:21', 16, 15, 'Chawarma+ 8e Tranche, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(84, 'SZK202509263fd3ea', 'SZK250926750430', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 15:54:59', '2025-09-26 15:54:59', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(85, 'SZK202509264a5b69', 'SZK250926994138', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 15:55:04', '2025-09-26 15:55:04', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(86, 'SZK20250926e90316', 'SZK250926194716', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 2924.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 16:19:17', '2025-09-26 16:19:17', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(87, 'SZK20250926dacafb', 'SZK250926258726', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 16:19:29', '2025-09-26 16:19:29', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(88, 'SZK202509263c3373', 'SZK250926337004', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 16:31:55', '2025-09-26 16:31:55', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(89, 'SZK20250926664679', 'SZK250926855180', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 16:32:27', '2025-09-26 16:32:27', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(90, 'SZK202509267e8c10', 'SZK250926543250', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 0.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 16:32:39', '2025-09-26 16:32:39', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(91, 'SZK202509266d7e4b', 'SZK250926883754', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 2921.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 16:39:50', '2025-09-26 16:39:50', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(92, 'SZK2025092621aef9', 'SZK250926279685', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 17:01:22', '2025-09-26 17:01:22', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(93, 'SZK20250926c8c987', 'SZK250926854980', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 17:16:47', '2025-09-26 17:16:47', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(94, 'SZK20250926b6b815', 'SZK250926640512', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 17:16:52', '2025-09-26 17:16:52', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(95, 'SZK20250926d2ec12', 'SZK250926452490', 'particulier', 1, NULL, NULL, '', '', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, '', 3394.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 17:57:12', '2025-09-26 17:57:12', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(96, 'SZK202509265a8198', 'SZK250926662057', 'particulier', 1, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 3394.00, 0.00, 3394.00, 'especes', 3394.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 18:34:16', '2025-09-26 18:34:16', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(97, 'SZK2025092686c1cf', 'SZK250926361174', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 3448.00, 0.00, 3448.00, 'especes', 3448.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 18:45:52', '2025-09-26 18:45:52', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(98, 'SZK2025092651d96f', 'SZK250926245028', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 20:24:46', '2025-09-26 20:24:46', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(99, 'SZK20250926ce55e3', 'SZK250926526667', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 20:40:21', '2025-09-26 20:40:21', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(100, 'SZK2025092661dccb', 'SZK250926251749', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 20:40:27', '2025-09-26 20:40:27', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(101, 'SZK20250926e41853', 'SZK250926282338', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 20:47:46', '2025-09-26 20:47:46', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(102, 'SZK20250926556783', 'SZK250926627155', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 21:37:22', '2025-09-26 21:37:22', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(103, 'SZK20250926b8e543', 'SZK250926846873', 'particulier', 1, NULL, 'ClientExp0707', '2250707070707', 'Test Départ Cocody', 5.33640000, -4.02670000, 'Test Destination Plateau', 5.35000000, -4.01000000, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2000.00, 0.00, 2000.00, 'especes', 2000.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 21:55:39', '2025-09-26 21:55:39', 66, 67, 'Test Départ Cocody', NULL, NULL, 'Test Destination Plateau', NULL, NULL, '2250707070707', '2250808080808'),
(104, 'SZK20250926c5a664', 'SZK250926639192', 'particulier', 1, NULL, 'ClientExp0707', '2250707070707', 'Test Départ Cocody', 5.33640000, -4.02670000, 'Test Destination Plateau', 5.35000000, -4.01000000, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2000.00, 0.00, 2000.00, 'especes', 2000.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-26 21:58:21', '2025-09-26 21:58:21', 66, 67, 'Test Départ Cocody', NULL, NULL, 'Test Destination Plateau', NULL, NULL, '2250707070707', '2250808080808'),
(105, 'SZK20250927f6d1d5', 'SZK250927726006', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-27 00:17:15', '2025-09-27 00:17:15', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(106, 'SZK20250927960cb6', 'SZK250927868589', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-27 00:38:41', '2025-09-27 00:38:41', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(107, 'SZK20250927082e24', 'SZK250927805578', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-27 01:59:34', '2025-09-27 01:59:34', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(108, 'SZK202509274411ac', 'SZK250927917906', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-27 02:24:45', '2025-09-27 02:24:45', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029'),
(109, 'SZK2025092760d818', 'SZK250927106380', 'particulier', 16, NULL, 'ClientExp3769', '2250102453769', 'Champroux Stadium, Abidjan, Côte d\'Ivoire', 5.30509750, -3.99246690, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', 5.25082460, -3.94498370, '', NULL, NULL, NULL, 0, NULL, 'nouvelle', 'normale', NULL, NULL, NULL, NULL, NULL, 2923.00, 0.00, 2923.00, 'especes', 2923.00, 'attente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-27 02:40:47', '2025-09-27 02:40:47', 16, 15, 'Champroux Stadium, Abidjan, Côte d\'Ivoire', NULL, NULL, 'Sipim Atlantide PORT-BOUËT, Abidjan, Côte d\'Ivoire', NULL, NULL, '2250102453769', '2250758842029');
...
--
-- Déchargement des données de la table `commandes_classiques`
--
...
--
-- Déchargement des données de la table `commandes_coursier`
--
...
(2, 5, 'Client Test Notification', '0652810937', 'Point de retrait test', 'Destination test', 3.00, 3000.00, 'Test notification complète - 2025-09-22 06:49:40', 'nouvelle', '2025-09-22 06:49:40', NULL, NULL, 'Standard', '2025-09-22 04:49:40', '2025-09-22 04:49:40'),
(3, 5, 'Client Test Notification', '0682926906', 'Point de retrait test', 'Destination test', 3.00, 3000.00, 'Test notification complète - 2025-09-22 06:52:00', 'nouvelle', '2025-09-22 06:52:00', NULL, NULL, 'Standard', '2025-09-22 04:52:00', '2025-09-22 04:52:00');
...
--
-- Déchargement des données de la table `commandes_coursiers`
--
...
(1, 'tarif_base_km', '300', 'Tarif de base par kilomètre en FCFA', 'decimal', '2025-08-08 09:03:00'),
...
(6, 'bonus_rapidite_seuil', '15', 'Seuil en minutes pour le bonus rapidité', 'integer', '2025-08-08 09:03:00'),
(7, 'bonus_rapidite_montant', '500', 'Montant du bonus rapidité en FCFA', 'decimal', '2025-08-08 09:03:00'),
(8, 'penalite_retard_seuil', '30', 'Seuil en minutes pour pénalité retard', 'integer', '2025-08-08 09:03:00'),
(9, 'penalite_retard_montant', '1000', 'Montant de la pénalité retard en FCFA', 'decimal', '2025-08-08 09:03:00'),
...
(12, 'twilio_phone_number', '', 'Numéro de téléphone Twilio', 'string', '2025-08-08 09:03:00'),
(13, 'google_maps_api_key', '', 'Clé API Google Maps', 'string', '2025-08-08 09:03:00'),
(14, 'cinetpay_api_key', '', 'Clé API CinetPay', 'string', '2025-08-08 09:03:00'),
(15, 'shipday_api_key', '', 'Clé API ShipDay', 'string', '2025-08-08 09:03:00');
...
--
-- Déchargement des données de la table `dispatch_locks`
--
...
--
-- Déchargement des données de la table `parametres_tarification`
--
...
(5, 'Agent Commercial', 'Prospection BtoB', 'Développement de la clientèle entreprise.', 'Sens du relationnel', '1 an', '2025-10-29', 'actif');
...
--
-- Déchargement des données de la table `support_chats`
--
...
(8, 'CHAT_1755775635_9e27a1e67', 'client', 'Client Test Exact', 'test@exact.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Cocody', '193.203.239.82', 'Mozilla/5.0 (Test Browser)', '{\"userAgent\":\"Mozilla\\/5.0 (Test Browser)\",\"platform\":\"Test Platform\",\"language\":\"fr-FR\"}', 0, '2025-08-21 11:27:16', '2025-08-21 11:27:16', NULL, NULL, 'active'),
(10, 'CHAT_1755775979_f9d55006c', 'client', 'Client Test Exact', 'test@exact.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Cocody', '193.203.239.82', 'Mozilla/5.0 (Test Browser)', '{\"userAgent\":\"Mozilla\\/5.0 (Test Browser)\",\"platform\":\"Test Platform\",\"language\":\"fr-FR\"}', 0, '2025-08-21 11:32:59', '2025-08-21 11:32:59', NULL, NULL, 'active'),
(13, 'CHAT_1755776298_0af5e4961', 'client', 'Client Test Exact', 'test@exact.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Cocody', '193.203.239.82', 'Mozilla/5.0 (Test Browser)', '{\"userAgent\":\"Mozilla\\/5.0 (Test Browser)\",\"platform\":\"Test Platform\",\"language\":\"fr-FR\"}', 0, '2025-08-21 11:38:18', '2025-08-21 11:38:18', NULL, NULL, 'active'),
(14, 'DIRECT_TEST_1755776550', 'client', 'Test Direct', 'direct@test.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Cocody', '193.203.239.82', 'Direct Test Browser', '{\"userAgent\":\"Direct Test Browser\",\"platform\":\"Direct Test\",\"language\":\"fr-FR\"}', 0, '2025-08-21 11:42:30', '2025-08-21 11:42:30', NULL, NULL, 'active'),
(15, 'DIRECT_TEST_1755776724', 'client', 'Test Direct', 'direct@test.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Cocody', '193.203.239.82', 'Direct Test Browser', '{\"userAgent\":\"Direct Test Browser\",\"platform\":\"Direct Test\",\"language\":\"fr-FR\"}', 0, '2025-08-21 11:45:24', '2025-08-21 11:45:24', NULL, NULL, 'active'),
(16, 'DEBUG_TEST_1755776931', 'client', 'Debug Test', 'debug@test.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Cocody', '193.203.239.82', 'Debug Browser', '{\"userAgent\":\"Debug Browser\",\"platform\":\"Debug\",\"language\":\"fr-FR\"}', 0, '2025-08-21 11:48:51', '2025-08-21 11:48:51', NULL, NULL, 'active'),
(21, 'DEBUG_INIT_1755777180', 'client', 'Test Debug Init', 'debug@init.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Cocody', '193.203.239.82', 'Debug Browser', '{\"userAgent\":\"Debug Browser\",\"platform\":\"Debug Platform\",\"language\":\"fr-FR\"}', 0, '2025-08-21 11:53:00', '2025-08-21 11:53:00', NULL, NULL, 'active'),
(22, 'CHAT_1755777274_8af5db2ff', 'client', 'Client Test Exact', 'test@exact.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Cocody', '193.203.239.82', 'Mozilla/5.0 (Test Browser)', '{\"userAgent\":\"Mozilla\\/5.0 (Test Browser)\",\"platform\":\"Test Platform\",\"language\":\"fr-FR\"}', 0, '2025-08-21 11:54:34', '2025-08-21 11:54:34', NULL, NULL, 'active'),
...
(25, 'TEST_FINAL_1755782072', 'client', 'Test Final', 'test@final.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Test', '193.203.239.82', 'Test Browser', '{\"userAgent\":\"Test Browser\",\"platform\":\"Test\",\"language\":\"fr-FR\"}', 0, '2025-08-21 13:14:32', '2025-08-21 13:14:32', NULL, NULL, 'active'),
(26, 'TEST_FINAL_1755782292', 'client', 'Test Final', 'test@final.com', '+225 07 12 34 56 78', 'Côte d\'Ivoire', 'Abidjan', 'Test', '193.203.239.82', 'Test Browser', '{\"userAgent\":\"Test Browser\",\"platform\":\"Test\",\"language\":\"fr-FR\"}', 0, '2025-08-21 13:18:12', '2025-08-21 13:18:12', NULL, NULL, 'active');
...
--
-- Déchargement des données de la table `system_sync_heartbeats`
--
...
(2, 'Abidjan Étendue', 5.00, 15.00, 3000.00, 400.00, 1, '2025-08-10 13:30:45'),
...
--
-- Déchargement des données de la table `tracking_coursiers`
--
