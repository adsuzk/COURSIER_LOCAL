...
class SuzoskyCinetPayIntegration {
    ...
    // Disable SSL host verification for local environments
    ...
    $host = $_SERVER['HTTP_HOST'] ?? 'coursier.conciergerie-privee-suzosky.com';
    // Move up two directories from api/script to project root
    $basePath = rtrim(dirname(dirname($_SERVER['PHP_SELF'] ?? '')), '/\\');
    return $protocol . $host . $basePath . '/cinetpay/payment_return.php';
    }
    ...
    $host = $_SERVER['HTTP_HOST'] ?? 'coursier.conciergerie-privee-suzosky.com';
    $basePath = rtrim(dirname(dirname($_SERVER['PHP_SELF'] ?? '')), '/\\');
    return $protocol . $host . $basePath . '/cinetpay/payment_notify.php';
    }
