...
<div class="sub-tabs">
    ...
    <div class="sub-tab-content">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" style="display:inline">
                                ...
                                <select name="statut" onchange="this.form.submit()" style="background: var(--glass-bg); border: 1px solid var(--glass-border); color: #FFF; border-radius: 6px; padding: 5px;">
        ...
        <div id="list-candidatures" class="sub-tab-section" style="display:none">
            <table class="data-table">
                <thead><tr>
                    <th>ID</th><th>Poste</th><th>Nom</th><th>Prénoms</th><th>Email</th><th>Téléphone</th><th>Date Candidature</th><th>Statut</th><th>Actions</th>
                </tr></thead>
                <tbody>
