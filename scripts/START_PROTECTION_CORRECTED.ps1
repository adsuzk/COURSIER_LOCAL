# SCRIPT DE PROTECTION AUTOMATIQUE SUZOSKY - VERSION CORRIGÉE
# Token testé et fonctionnel: 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

param()
$ErrorActionPreference = "Continue"
$HOST.UI.RawUI.WindowTitle = "SUZOSKY - Protection GitHub Auto - CORRIGÉE"

Clear-Host
Write-Host "================================================================" -ForegroundColor Magenta
Write-Host "    SUZOSKY - PROTECTION AUTOMATIQUE GITHUB - VERSION CORRIGÉE" -ForegroundColor Magenta  
Write-Host "================================================================" -ForegroundColor Magenta
...
$repoUrl = "https://$GIT_USERNAME`:$WORKING_TOKEN@github.com/"
git config --global url."$repoUrl".insteadOf "https://github.com/"
...
if ($LASTEXITCODE -eq 0) {
    ...
    $commitHash = $testResult.Split()[0]
    if ($commitHash.Length -ge 7) {
        Write-Host "Dernier commit: $($commitHash.Substring(0,7))" -ForegroundColor Green
    }
} else {
