<?php
// sections/header.php - En-tête complet avec métadonnées SEO
?><!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav class="main-nav">
        <div class="nav-container">
            <div class="nav-logo">
                <img src="assets/logo-suzosky.svg" alt="Conciergerie Privée Suzosky" class="logo-img">
                <div class="logo-text">
            ...
            <div class="mobile-menu-content">
                <div class="mobile-menu-header">
                    <div class="mobile-logo">
                        <img src="assets/logo-suzosky.svg" alt="Suzosky" class="mobile-logo-img">
                ...
                <div class="mobile-menu-links">
                    ...
                    <a href="recrutement.php" class="mobile-nav-link" onclick="toggleMobileMenu()">👥 Recrutement</a>
                    <a href="cgu.html" class="mobile-nav-link" onclick="toggleMobileMenu()">📋 CGU</a>
